...
const IconAreaHorizontalSpacingPrefsWidget = new GObject.Class({
    Name: 'IconAreaHorizontalSpacing.Prefs.Widget',
    GTypeName: 'IconAreaHorizontalSpacingPrefsWidget',
    Extends: Gtk.Grid,
...
function buildPrefsWidget() {
    let widget = new IconAreaHorizontalSpacingPrefsWidget();
    if (widget.show_all)
      widget.show_all();
